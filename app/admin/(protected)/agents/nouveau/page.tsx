...
export default function NouveauAgentPage() {
  ...
  return (
    <PageFrame
      ...
      detail={true}
      sections={[
        { id: "section-1", label: "Identité de l’utilisateur" },
        { id: "section-2", label: "Identifiants du compte" },
        { id: "section-3", label: "Rôle de l’utilisateur" },
      ]}
    >
            ...
            <div className="flex min-w-0 items-start gap-3 sm:gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-2 max-w-2xl text-[13px] leading-6 text-slate-500 sm:mt-3 sm:text-sm sm:leading-7">
                  Créez un compte agent ou administrateur pour l’espace de
                  gestion IF Sigorta.
                </p>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="min-w-0 p-4 sm:p-6 lg:p-8">
            <div>
              <div className="mb-5">
                ...
                <h2
                  className="mt-2 text-lg font-semibold text-[#102B20]"
                  id="section-1"
                >
                  ...
                  <div className="flex min-w-0 items-start justify-between gap-3 sm:gap-4">
                    <div>
                      ...
                      <span className="mt-2 block text-[12px] leading-5 text-slate-500 sm:text-sm sm:leading-6">
                        Peut traiter les dossiers clients et gérer les
                        opérations qui lui sont autorisées.
                      </span>
                    </div>
                ...
                >
                  <div className="flex min-w-0 items-start justify-between gap-3 sm:gap-4">
                    <div>
                      ...
                      <span className="mt-2 block text-[12px] leading-5 text-slate-500 sm:text-sm sm:leading-6">
                        Dispose de l’accès complet, y compris la gestion des
                        agents.
                      </span>
                    </div>
