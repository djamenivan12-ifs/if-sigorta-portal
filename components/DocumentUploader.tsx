    ...
    <div>
      ...
      {!file ? (
        <label className="mt-3 flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-300 px-4 py-8 text-center transition hover:border-[#0B5D3B] hover:bg-[#F3F8F2]">
          ...
          <span className="mt-3 font-semibold text-[#0B5D3B]">
            {t.chooseFile}
          </span>
        ...
        <div className="mt-3 flex items-center justify-between gap-4 rounded-2xl border border-[#CFE3CF] bg-[#F3F8F2] p-4">
          ...
          <button
            ...
            className="shrink-0 rounded-lg border border-red-200 bg-white px-3 py-2 text-sm font-semibold text-red-700 transition hover:bg-red-50"
          >
            {t.remove}
          </button>
        </div>
